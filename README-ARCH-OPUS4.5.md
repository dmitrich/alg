...
**Project:** ALG1 - GPT Model Refactoring Project
...
- **Model Architecture**: Multi-head self-attention transformer with feed-forward networks
- **Training**: AdamW optimizer with cross-entropy loss
- **Configuration**: Multi-source configuration with CLI overrides
- **Experiment Tracking**: Parallel tracking with Aim and TensorBoard
- **Metadata Capture**: Git state, environment info, and configuration
- **Model Persistence**: SafeTensors format for secure, fast loading
...
├── README-ARCH-QWEN3.md        # Architecture document (Qwen3)
├── README-ARCH-OPUS4.5.md      # Architecture document (Opus4.5)
...
- **FeedFoward**: MLP with ReLU activation (4× expansion)
